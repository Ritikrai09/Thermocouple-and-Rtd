...
function plot2(){
 ...
 //console.log(data2x);
  ...
  function dynamic(){
    ...
    data1y.push.apply(data1y, test);
    
    var yaxis1= data1y.sort(function(a, b){return a-b});
    
    
    data1x.push.apply(data1x, dynamic1);
     var xaxis1= data1x.sort(function(a, b){return a-b});
    ...
    let lineChart= new Chart(myChart3,{
      ...
      options:{
        title:{
          display:true,
          text:"Tempertature VS Time Constant"
        }
      }
    ...
    function dynamic2(){
      ...
      data1x.push.apply(data1x, dynamic22);
       var xaxis1= data1x.sort(function(a, b){return a-b});
      
      
      let myChart4=document.getElementById("myChart4").getContext("2d");
      
      let lineChart= new Chart(myChart4,{
        type:"line",
        data:{
          labels:xaxis1,
          datasets:[{
